! function(e, t) {
    ...
    var x = function(e) {
        ...
        try {
            j.apply(D = O.call(w.childNodes), w.childNodes), D[w.childNodes.length].nodeType
        } catch (t) {
            j = {
                ...
                if (n = r.relative[e[l].type]) d = [_e(we(d), n)];
                    ...
                    if ((n = r.filter[e[l].type].apply(null, e[l].matches))[_]) {
                        ...
                        return xe(1 < l && we(d), 1 < l && be(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(W, "$1"), n, l < i && Se(e.slice(l, i)), i < o && Se(e = e.slice(i)), i < o && be(e))
                    }
                    d.push(n)
                }
            return we(d)
        ...
        return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function(e, t) {
            ...
            var n, i, o, s, l, c, f = [],
                ...
                g = C[e + " "];
            if (!g) {
                for (t || (t = a(e)), n = t.length; n--;)(g = Se(t[n]))[_] ? f.push(g) : p.push(g);
    ...
    w.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!q(this, "string" == typeof e && C.test(e) ? w(e) : e || [], !1).length
        }
    });
    var D, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    function je(e, t, n, r) {
        ...
        if (d && (a = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
            for (l = (s = w.map(ge(i, "script"), De)).length; f < d; f++) u = i, f !== m && (u = w.clone(u, !0, !0), l && w.merge(s, ge(u, "script"))), n.call(e[f], u, f);
            if (l)
                for (c = s[s.length - 1].ownerDocument, w.map(s, Ne), f = 0; f < l; f++) u = s[f], pe.test(u.type || "") && !Y.access(u, "globalEval") && w.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? w._evalUrl && !u.noModule && w._evalUrl(u.src, {
    ...
    Mt.href = Et.href, w.extend({
        ...
        ajax: function(t, n) {
            ...
            if (v.promise(S), h.url = ((t || h.url || Et.href) + "").replace(It, Et.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(I) || [""], null == h.crossDomain) {
                l = g.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = w.param(h.data, h.traditional)), Bt(Rt, h, n, S), u) return S;
            for (f in (c = w.event && h.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ot.test(h.type), i = h.url.replace(Nt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Dt, "+")) : (d = h.url.slice(i.length), h.data && (h.processData || "string" == typeof h.data) && (i += (St.test(i) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (i = i.replace(Lt, "$1"), d = (St.test(i) ? "&" : "?") + "_=" + xt.guid++ + d), h.url = i + d), h.ifModified && (w.lastModified[i] && S.setRequestHeader("If-Modified-Since", w.lastModified[i]), w.etag[i] && S.setRequestHeader("If-None-Match", w.etag[i])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && S.setRequestHeader("Content-Type", h.contentType), S.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ht + "; q=0.01" : "") : h.accepts["*"]), h.headers) S.setRequestHeader(f, h.headers[f]);
            if (h.beforeSend && (!1 === h.beforeSend.call(p, S, h) || u)) return S.abort();
            if (x = "abort", y.add(h.complete), S.done(h.success), S.fail(h.error), r = Bt(Pt, h, n, S)) {
            ...
            function T(t, n, a, l) {
                var f, d, g, _, E, x = n;
                u || (u = !0, s && e.clearTimeout(s), r = void 0, o = l || "", S.readyState = 0 < t ? 4 : 0, f = 200 <= t && t < 300 || 304 === t, a && (_ = function(e, t, n) {
                ...
                }(h, S, a)), !f && -1 < w.inArray("script", h.dataTypes) && w.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function() {}), _ = function(e, t, n, r) {
                    var i, o, a, s, l, u = {},
                        c = e.dataTypes.slice();
                    if (c[1])
                ...
                }(h, _, S, f), f ? (h.ifModified && ((E = S.getResponseHeader("Last-Modified")) && (w.lastModified[i] = E), (E = S.getResponseHeader("etag")) && (w.etag[i] = E)), 204 === t || "HEAD" === h.type ? x = "nocontent" : 304 === t ? x = "notmodified" : (x = _.state, d = _.data, f = !(g = _.error))) : (g = x, !t && x || (x = "error", t < 0 && (t = 0))), S.status = t, S.statusText = (n || x) + "", f ? v.resolveWith(p, [d, x, S]) : v.rejectWith(p, [S, x, g]), S.statusCode(b), b = void 0, c && m.trigger(f ? "ajaxSuccess" : "ajaxError", [S, h, f ? d : g]), y.fireWith(p, [S, x]), c && (m.trigger("ajaxComplete", [S, h]), --w.active || w.event.trigger("ajaxStop")))
            }
            return S
        },
    ...
    w.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = p(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Vt, "$1" + i) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
...
function(e, t) {
                    ...
                    if (i) {
                        if ("radio" === i.type)
                            if (i.checked && this._element.classList.contains(S)) e = !1;
                                ...
                                o && r.default(o).removeClass(S)
                            }
                        e && ("checkbox" !== i.type && "radio" !== i.type || (i.checked = !this._element.classList.contains(S)), this.shouldAvoidTriggerChange || r.default(i).trigger("change")), i.focus(), t = !1
                    }
                }
                this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (t && this._element.setAttribute("aria-pressed", !this._element.classList.contains(S)), e && r.default(this._element).toggleClass(S))
            }, t.dispose = function() {
    ...
    r.default(document).on(T, A, (function(e) {
        var t = e.target,
            n = t;
        if (r.default(t).hasClass("btn") || (t = r.default(t).closest(D)[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault();
        else {
            var i = t.querySelector(q);
            if (i && (i.hasAttribute("disabled") || i.classList.contains("disabled"))) return void e.preventDefault();
            "INPUT" !== n.tagName && "LABEL" === t.tagName || N._jQueryInterface.call(r.default(t), "toggle", "INPUT" === n.tagName)
        }
    })).on(C, A, (function(e) {
        var t = r.default(e.target).closest(D)[0];
    ...
    })), r.default.fn[b] = N._jQueryInterface, r.default.fn[b].Constructor = N, r.default.fn[b].noConflict = function() {
        return r.default.fn[b] = x, N._jQueryInterface
    };
    var L = "carousel",
        j = "bs.carousel",
        O = "." + j,
    ...
    var Se = Ee && window.Promise ? function(e) {
        var t = !1;
        return function() {
    ...
    var De = Ee && !(!window.MSInputMethodContext || !document.documentMode),
        Ne = Ee && /MSIE 10/.test(navigator.userAgent);

    function Le(e) {
        return 11 === e ? De : 10 === e ? Ne : De || Ne
    }
    ...
    function ot(e, t, n) {
        return (void 0 === n ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && Te(n) && (t.offsets.popper = $e(t.offsets.popper), t.offsets.reference = $e(t.offsets.reference), t = n(t, e))
        })), t
    }
    ...
    var Ct = {
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var n = t.offset,
                        ...
                        s = r.split("-")[0],
                        l = void 0;
                    return l = mt(+n) ? [+n, 0] : Tt(n, o, a, s), "left" === s ? (o.top += l[0], o.left -= l[1]) : "right" === s ? (o.top += l[0], o.left += l[1]) : "top" === s ? (o.left += l[0], o.top -= l[1]) : "bottom" === s && (o.left += l[0], o.top += l[1]), e.popper = o, e
                },
                offset: 0
            },
            preventOverflow: {
        ...
        At = function() {
            function e(t, n) {
                ...
                }, this.update = Se(this.update.bind(this)), this.options = Qe({}, e.Defaults, i), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
    ...
    var qt = At,
        ...
        Gt = function() {
            ...
            return t.toggle = function() {
                ...
                if (void 0 === t && (t = !1), !(this._element.disabled || r.default(this._element).hasClass(Rt) || r.default(this._menu).hasClass(Pt))) {
                    ...
                    if (r.default(o).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar && t) {
                            ...
                            var a = this._element;
                            "parent" === this._config.reference ? a = o : c.isElement(this._config.reference) && (a = this._config.reference, void 0 !== this._config.reference.jquery && (a = this._config.reference[0])), "scrollParent" !== this._config.boundary && r.default(o).addClass("position-static"), this._popper = new qt(a, this._menu, this._getPopperConfig())
                        }
                ...
                r.default.removeData(this._element, Nt), r.default(this._element).off(Lt), this._element = null, this._menu = null, null !== this._popper && (this._popper.destroy(), this._popper = null)
            }, t.update = function() {
                ...
                return e = a({}, this.constructor.Default, r.default(this._element).data(), e), c.typeCheckConfig(Dt, e, this.constructor.DefaultType), e
                ...
                return this.each((function() {
                    var n = r.default(this).data(Nt);
                    if (n || (n = new e(this, "object" == typeof t ? t : null), r.default(this).data(Nt, n)), "string" == typeof t) {
    ...
    r.default(document).on($t, Vt, Gt._dataApiKeydownHandler).on($t, Xt, Gt._dataApiKeydownHandler).on(Qt + " " + zt, Gt._clearMenus).on(Qt, Vt, (function(e) {
        ...
        e.stopPropagation()
    })), r.default.fn[Dt] = Gt._jQueryInterface, r.default.fn[Dt].Constructor = Gt, r.default.fn[Dt].noConflict = function() {
        return r.default.fn[Dt] = Ot, Gt._jQueryInterface
    };
    var Jt = "modal",
        Zt = "bs.modal",
        en = "." + Zt,
    ...
    var Sn = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"],
        Tn = {
        ...
        for (var r = (new window.DOMParser).parseFromString(e, "text/html"), i = Object.keys(t), o = [].slice.call(r.body.querySelectorAll("*")), a = function(e, n) {
                ...
                s.forEach((function(e) {
                    (function(e, t) {
                        ...
                        if (-1 !== t.indexOf(n)) return -1 === Sn.indexOf(n) || Boolean(Cn.test(e.nodeValue) || kn.test(e.nodeValue));
        ...
        zn = function() {
            ...
            return t.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    r.default(o).data(this.constructor.DATA_KEY, this), r.default.contains(this.element.ownerDocument.documentElement, this.tip) || r.default(o).appendTo(u), r.default(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new qt(this.element, o, this._getPopperConfig(l)), r.default(o).addClass(Pn), r.default(o).addClass(this.config.customClass), "ontouchstart" in document.documentElement && r.default(document.body).children().on("mouseover", null, r.default.noop);
                    var f = function() {
                ...
                return Object.keys(t).forEach((function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), c.typeCheckConfig(qn, e, this.constructor.DefaultType), e.sanitize && (e.template = An(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                return this.each((function() {
                    var n = r.default(this),
                        i = n.data(Dn),
                        o = "object" == typeof t && t;
                    if ((i || !/dispose|hide/.test(t)) && (i || (i = new e(this, o), n.data(Dn, i)), "string" == typeof t)) {
                        if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                        i[t]()
                    }
                }))
    ...
    r.default.fn[qn] = zn._jQueryInterface, r.default.fn[qn].Constructor = zn, r.default.fn[qn].noConflict = function() {
        return r.default.fn[qn] = Ln, zn._jQueryInterface
    };
    var Vn = "popover",
        Xn = "bs.popover",
        Yn = "." + Xn,
        ...
        Lr = function() {
            ...
            return t.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && r.default(this._element).hasClass(Er) || r.default(this._element).hasClass("disabled") || this._element.hasAttribute("disabled"))) {
                    ...
                    if (i) {
                        var a = "UL" === i.nodeName || "OL" === i.nodeName ? Nr : Dr;
                        n = (n = r.default.makeArray(r.default(i).find(a)))[n.length - 1]
                    }
                    var s = r.default.Event(Tr, {
                            relatedTarget: this._element
                        }),
                ...
                var i = this,
                    o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? r.default(t).children(Dr) : r.default(t).find(Nr))[0],
                ...
                if (o && a) {
                    ...
                    r.default(o).removeClass(Sr).one(c.TRANSITION_END, s).emulateTransitionEnd(l)
                } else s()
                ...
                r.default(e).addClass(Er), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), c.reflow(e), e.classList.contains(xr) && e.classList.add(Sr);
                var o = e.parentNode;
    ...
    r.default(document).on(qr, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(e) {
    ...
    }, e.Alert = y, e.Button = N, e.Carousel = re, e.Collapse = we, e.Dropdown = Gt, e.Modal = xn, e.Popover = nr, e.Scrollspy = vr, e.Tab = Lr, e.Toast = Vr, e.Tooltip = zn, e.Util = c, Object.defineProperty(e, "__esModule", {
        value: !0
    })
})),
function(e, t) {
...
if (document.querySelector("#form-coupon") && document.querySelector("#i-type").addEventListener("change", (function() {
        ...
        e.stopPropagation()
    })), new ClipboardJS('[data-clipboard="true"]'), document.querySelectorAll("[data-clipboard-copy]").forEach((function(e) {
        ...
        document.querySelectorAll(".single-link").forEach((e => e.classList.add("d-block"))), document.querySelectorAll(".multiple-links").forEach((e => e.classList.remove("d-block"))), document.querySelector("#i-alias").removeAttribute("disabled"), window.setTimeout((function() {
        ...
        document.querySelectorAll(".multiple-links").forEach((e => e.classList.add("d-block"))), document.querySelectorAll(".single-link").forEach((e => e.classList.remove("d-block"))), document.querySelector("#i-alias").setAttribute("disabled", "disabled"), window.setTimeout((function() {
        ...
        })), this.classList.add("btn-success"), this.classList.remove("btn-primary"), document.querySelector("#copy-form-container input").removeAttribute("style"), setTimeout((function() {
            jQuery("#copy-form-container").fadeOut("done", (function() {
                jQuery("#short-form-container").fadeIn(), document.querySelector('input[name="url"]').focus()
            }))
        }), 500)
    })), document.querySelector("#i-urls") && document.querySelector("#i-urls").addEventListener("input", (function() {
        this.style.height = "auto", this.style.height = this.scrollHeight + "px", this.style.overflowY = "hidden"
    }), !1), jQuery('[data-toggle="tooltip-url"]').tooltip({
        animation: !0,
        delay: {
            show: 500,
            hide: 100
        }
    }), document.querySelectorAll('input[name="target_type"]')) {
    document.querySelectorAll('input[name="target_type"]').forEach((function(e) {
        e.addEventListener("click", (function() {
            document.querySelector("#i-target-type").removeAttribute("id"), this.setAttribute("id", "i-target-type")
        }))
    }));
    let e = document.querySelectorAll('input[name="target_type"]');
    for (let t = 0, n = e.length; t < n; t++) e[t].checked && 1 == document.querySelector(e[t].dataset.target).querySelectorAll('input[data-input="value"]').length && document.querySelector(e[t].dataset.target + " .input-add") && document.querySelector(e[t].dataset.target + " .input-add").click(), e[t].onchange = function(e) {
        1 == document.querySelector(this.dataset.target).querySelectorAll('input[data-input="value"]').length && document.querySelector(this.dataset.target + " .input-add") && document.querySelector(this.dataset.target + " .input-add").click(), document.querySelectorAll('input[name="target_type"]').forEach((e => e.classList.remove("active"))), jQuery(this).tab("show")
    }
}
document.querySelectorAll("#country-container, #platform-container, #language-container, #rotation-container").forEach((e => {
    e.addEventListener("click", (function(t) {
        let n, r = this.getAttribute("id");
        if (n = "country-container" == e.getAttribute("id") ? "country" : "platform-container" == e.getAttribute("id") ? "platform" : "language-container" == e.getAttribute("id") ? "language" : "rotation", t.target.closest(".input-delete") && (t.target.closest(".input-delete").parentNode.parentNode.remove(), 1 == e.querySelectorAll('input[data-input="value"]').length && (e.querySelector('input[name="' + n + '[empty][key]"]') && e.querySelector('input[name="' + n + '[empty][key]"]').removeAttribute("disabled"), e.querySelector('input[name="' + n + '[empty][value]"]').removeAttribute("disabled"))), t.target.closest(".input-add")) {
            let t = document.querySelector("#" + r + " .input-template").cloneNode(!0);
            t.classList.remove("d-none", "input-template"), t.querySelector("select") && t.querySelector("select").removeAttribute("disabled"), t.querySelector("input").removeAttribute("disabled");
            let i = (new Date).getTime();
            t.querySelector("select") && t.querySelector("select").setAttribute("name", n + "[" + i + "][key]"), t.querySelector("input").setAttribute("name", n + "[" + i + "][value]"), t.querySelector("input").setAttribute("dir", "ltr"), e.querySelector('input[name="' + n + '[empty][key]"]') && e.querySelector('input[name="' + n + '[empty][key]"]').setAttribute("disabled", "disabled"), e.querySelector('input[name="' + n + '[empty][value]"]') && e.querySelector('input[name="' + n + '[empty][value]"]').setAttribute("disabled", "disabled"), document.querySelector("#" + r + " .input-content").append(t)
        }
    }))
})), document.querySelector("#utm-builder") && document.querySelector("#utm-builder").addEventListener("click", (function() {
    let e = document.querySelector("#i-url"),
        t = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"];
    try {
        let n = new URL(e.value);
        t.forEach((function(e) {
            n.searchParams.has(e) && (document.querySelector('input[name="' + e + '"]').value = n.searchParams.get(e))
        }))
    } catch (e) {
        t.forEach((function(e) {
...
})), document.querySelectorAll("#i-utm-source, #i-utm-medium, #i-utm-campaign, #i-utm-term, #i-utm-content").forEach((e => {
    e.addEventListener("input", (function() {
        let t = document.querySelector("#i-url");
        try {
            let n = new URL(t.value),
                r = e.getAttribute("name"),
                i = document.querySelector('input[name="' + r + '"]').value;
            "" === i ? n.searchParams.delete(r) : n.searchParams.set(r, i), t.value = n.href
        } catch (e) {}
    }))
...
Number.prototype.format = function(e, t, n, r) {
    ...
    return (r ? o.replace(".", r) : o).replace(new RegExp(i, "g"), "$&" + (n || ","))
};
let commarize = (e, t) => {
    if (e >= (t = t || 1e3)) {
        let t = ["K", "M", "B", "T"],
            ...
            r = t[n - 1];
        return Number((e / 1e3 ** n).toFixed(2)) + r
    }
